...
| Object | Purpose |
| --- | --- |
| Brand definition | Tool-independent source for named colors, optional free roles, typography, and asset paths. |
...
Brand colors keep their real names. Optional brand roles are free-form aliases, not a universal semantic vocabulary. The Nuxt UI adapter maps either named colors or role values to Nuxt UI's target roles such as `primary`, `success`, and `neutral`.
