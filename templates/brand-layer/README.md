...
This starter is for full build-time branding: assets, metadata, CSS variables, Nuxt UI defaults, and optional brand primitives. Replace the placeholder `brandIdentity` and logo entries in `brand.ts` with stable roles from the real brand system.
