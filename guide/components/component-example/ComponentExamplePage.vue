...
<template>
  ...
  <div
    v-else-if="props.name === 'content-navigation'"
    class="max-w-sm rounded-sm border border-default bg-default p-3"
  >
  ...
  <div
    v-else-if="props.name === 'content-toc'"
    class="max-w-sm rounded-sm border border-default bg-default p-3"
  >
    <UContentToc
      title="On this page"
  ...
  <div
    v-else-if="props.name === 'content-surround'"
  ...
  <div
    v-else-if="props.name === 'content-search'"
    class="space-y-4"
  >
  ...
  <UContainer
    v-else-if="props.name === 'container'"
    class="rounded-sm border border-default bg-default py-4"
  >
    <p class="text-sm text-muted">
  ...
  <div
    v-else-if="props.name === 'page-opening-pattern'"
    class="space-y-6"
  >
    <UPageHero
      :links="[
  ...
  <div
    v-else-if="props.name === 'section-system-pattern'"
    class="space-y-6"
  >
    <UPageSection
      :features="[
  ...
  <div
    v-else-if="props.name === 'page-support-pattern'"
    class="space-y-5"
  >
    <UPageLinks
      :links="[
  ...
  <div
    v-else-if="props.name === 'page-shell-pattern'"
    class="overflow-hidden rounded-sm border border-default bg-default"
  >
